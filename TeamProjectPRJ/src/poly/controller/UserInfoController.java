...
public class UserInfoController {
	...
	public String getUserLoginCheck(HttpSession session, HttpServletRequest request, HttpServletResponse response,
		...
		try {
			 ...
			 * 
			 * 예) 	톰켓에 100명의 사용자가 로그인했다면, 사용자 각각 회원아이디를 메모리에 저장한며,
			...
			if(res == 1) { //로그인 성공
				 ...
				 * 숫자 유형의 데이터 타입은 값을 전달하고 받는데 불편함이 있어 문자 유형(String)으로 강제 형변환하여 jsp에 전달한다.
				 */
    ...
    public String logoutresult(HttpSession session, ModelMap model) {
